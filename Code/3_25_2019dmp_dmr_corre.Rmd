...
########## also get the directionaliy of methylation by betafc (the beta fold change for given design)
  ...
  write.xlsx(fulllist, file =  paste("/home/guanshim/Documents/gitlab/ECCHO_github/DataProcessed/3chems_results_data/probesDMR/", sep = "_", name, pcutoff, "sigDMR.xlsx" ) )
  ...
  cpg1 = data.frame(fulllist) %>% dplyr::mutate(methylation1 = ifelse(direction1 > 0, 1, -1)) %>%
    ...
    write.xlsx(cpg1, file =  paste("/home/guanshim/Documents/gitlab/ECCHO_github/DataProcessed/3chems_results_data/topProbeDMR/", sep = "_", pcutoff, name,"topCpG.xlsx" ) )
    
}

getprobes_perDMR(f_pfhxs_dmr, f_pfhxs_DMP , anno, 1)
getprobes_perDMR(f_pfos_dmr, f_pfos_DMP , anno, 1)
getprobes_perDMR(f_pfoa_dmr, f_pfoa_DMP , anno, 1)

getprobes_perDMR(m_pfhxs_dmr, m_pfhxs_DMP , anno, 1)
getprobes_perDMR(m_pfos_dmr, m_pfos_DMP , anno, 1)
getprobes_perDMR(m_pfoa_dmr, m_pfoa_DMP , anno, 1)
