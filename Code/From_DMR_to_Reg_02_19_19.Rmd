...
dim(t_mval)
t_mval <- data.frame(t_mval) %>% mutate(pid = colnames(mval)) %>% select(pid, everything())
fwrite(t_mval, "~/Documents/gitlab/ECCHO_github/DataProcessed/for_obesity/t_mval.csv", )
