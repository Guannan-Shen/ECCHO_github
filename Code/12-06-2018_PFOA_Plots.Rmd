...
colnames(pfoa_coef)
##
pfoa_vol <- pfoa_coef %>% dplyr::rename( rawpF = `P value F` ,
                                         rawpM = `P value M`) %>% 
...
## top cpgs male
head(beta_pfoadiff_m[ order(beta_pfoadiff_m$rawpM),])
head(beta_pfoadiff_m)
## volcano plot of beta values 
...
paste("1. M values of more selected CpGs.", 
      "2. Why the number of CpGs diff between the association with PFOA data and the Diff between quartiles data",
