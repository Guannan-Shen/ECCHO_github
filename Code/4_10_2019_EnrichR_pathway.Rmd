...
### Female Enrichment Results from Top300 DMP or TOP1 CpG from p less than 0.05 DMR
...
### Male Enrichment Results from Top300 DMP or TOP1 CpG from p less than 0.05 DMR
...
f_pfhxs_1_1 <- getpathway_top( "top_f_pfhxs_1",  dbs, top1_gene)
kable(f_pfhxs_1_1$KEGG_2019_Human[1:5, ], 
      caption = "female pfhxs Top1 DMR_1: KEGG_2019_Human" )
kable(f_pfhxs_1_1$GO_Biological_Process_2018[1:5, ], 
      caption = "female pfhxs Top1 DMR_1: GO_Biological_Process_2018" )
kable(f_pfhxs_1_1$GO_Molecular_Function_2018[1:5, ], 
      caption = "female pfhxs Top1 DMR_1: GO_Molecular_Function_2018" )
kable(f_pfhxs_1_1$GO_Cellular_Component_2018[1:5, ], 
      caption = "female pfhxs Top1 DMR_1: GO_Cellular_Component_2018" )

f_pfhxs_500 <- getpathway_top( "f_pfhxs_DMP_500",  dbs, top500_gene)
kable(f_pfhxs_500$KEGG_2019_Human[1:5, ], 
      caption = "female pfhxs Top500 DMP: KEGG_2019_Human" )
kable(f_pfhxs_500$GO_Biological_Process_2018[1:5, ], 
      caption = "female pfhxs Top500 DMP: GO_Biological_Process_2018" )
kable(f_pfhxs_500$GO_Molecular_Function_2018[1:5, ], 
      caption = "female pfhxs Top500 DMP: GO_Molecular_Function_2018" )
kable(f_pfhxs_500$GO_Cellular_Component_2018[1:5, ], 
      caption = "female pfhxs Top500 DMP: GO_Cellular_Component_2018" )

f_pfos_1 <- getpathway_top( "top_f_pfos_1",  dbs, top1_gene)
kable(f_pfos_1$KEGG_2019_Human[1:5, ], 
      caption = "female pfos Top1 DMR: KEGG_2019_Human" )
kable(f_pfos_1$GO_Biological_Process_2018[1:20, ], 
      caption = "female pfos Top1 DMR: GO_Biological_Process_2018" )
...
f_pfos_500 <- getpathway_top( "f_pfos_DMP_500",  dbs, top500_gene)
kable(f_pfos_500$KEGG_2019_Human[1:5, ], 
      caption = "female pfos Top500 DMP: KEGG_2019_Human" )
kable(f_pfos_500$GO_Biological_Process_2018[1:5, ], 
      caption = "female pfos Top500 DMP: GO_Biological_Process_2018" )
kable(f_pfos_500$GO_Molecular_Function_2018[1:5, ], 
      caption = "female pfos Top500 DMP: GO_Molecular_Function_2018" )
kable(f_pfos_500$GO_Cellular_Component_2018[1:5, ], 
      caption = "female pfos Top500 DMP: GO_Cellular_Component_2018" )

f_pfoa_1 <- getpathway_top( "top_f_pfoa_1",  dbs, top1_gene)
kable(f_pfoa_1$KEGG_2019_Human[1:5, ], 
      caption = "female pfoa Top1 DMR: KEGG_2019_Human" )
kable(f_pfoa_1$GO_Biological_Process_2018[1:5, ], 
      caption = "female pfoa Top1 DMR: GO_Biological_Process_2018" )
...
f_pfoa_500 <- getpathway_top( "f_pfoa_DMP_500",  dbs, top500_gene)
kable(f_pfoa_500$KEGG_2019_Human[1:5, ], 
      caption = "female pfoa Top500 DMP: KEGG_2019_Human" )
kable(f_pfoa_500$GO_Biological_Process_2018[1:5, ], 
      caption = "female pfoa Top500 DMP: GO_Biological_Process_2018" )
kable(f_pfoa_500$GO_Molecular_Function_2018[1:5, ], 
      caption = "female pfoa Top500 DMP: GO_Molecular_Function_2018" )
kable(f_pfoa_500$GO_Cellular_Component_2018[1:5, ], 
      caption = "female pfoa Top500 DMP: GO_Cellular_Component_2018" )
...
m_pfhxs_1_1 <- getpathway_top( "top_m_pfhxs_1",  dbs, top1_gene)
kable(m_pfhxs_1_1$KEGG_2019_Human[1:5, ], 
      caption = "Male pfhxs Top1 DMR_1: KEGG_2019_Human" )
kable(m_pfhxs_1_1$GO_Biological_Process_2018[1:5, ], 
      caption = "Male pfhxs Top1 DMR_1: GO_Biological_Process_2018" )
kable(m_pfhxs_1_1$GO_Molecular_Function_2018[1:5, ], 
      caption = "Male pfhxs Top1 DMR_1: GO_Molecular_Function_2018" )
kable(m_pfhxs_1_1$GO_Cellular_Component_2018[1:5, ], 
      caption = "Male pfhxs Top1 DMR_1: GO_Cellular_Component_2018" )

m_pfhxs_500 <- getpathway_top( "m_pfhxs_DMP_500",  dbs, top500_gene)
kable(m_pfhxs_500$KEGG_2019_Human[1:5, ], 
      caption = "Male pfhxs Top500 DMP: KEGG_2019_Human" )
kable(m_pfhxs_500$GO_Biological_Process_2018[1:5, ], 
      caption = "Male pfhxs Top500 DMP: GO_Biological_Process_2018" )
kable(m_pfhxs_500$GO_Molecular_Function_2018[1:5, ], 
      caption = "Male pfhxs Top500 DMP: GO_Molecular_Function_2018" )
kable(m_pfhxs_500$GO_Cellular_Component_2018[1:5, ], 
      caption = "Male pfhxs Top500 DMP: GO_Cellular_Component_2018" )

m_pfos_1 <- getpathway_top( "top_m_pfos_1",  dbs, top1_gene)
kable(m_pfos_1$KEGG_2019_Human[1:5, ], 
      caption = "Male pfos Top1 DMR: KEGG_2019_Human" )
kable(m_pfos_1$GO_Biological_Process_2018[1:20, ], 
      caption = "Male pfos Top1 DMR: GO_Biological_Process_2018" )
...
m_pfos_500 <- getpathway_top( "m_pfos_DMP_500",  dbs, top500_gene)
kable(m_pfos_500$KEGG_2019_Human[1:5, ], 
      caption = "Male pfos Top500 DMP: KEGG_2019_Human" )
kable(m_pfos_500$GO_Biological_Process_2018[1:5, ], 
      caption = "Male pfos Top500 DMP: GO_Biological_Process_2018" )
kable(m_pfos_500$GO_Molecular_Function_2018[1:5, ], 
      caption = "Male pfos Top500 DMP: GO_Molecular_Function_2018" )
kable(m_pfos_500$GO_Cellular_Component_2018[1:5, ], 
      caption = "Male pfos Top500 DMP: GO_Cellular_Component_2018" )

m_pfoa_1 <- getpathway_top( "top_m_pfoa_1",  dbs, top1_gene)
kable(m_pfoa_1$KEGG_2019_Human[1:5, ], 
      caption = "Male pfoa Top1 DMR: KEGG_2019_Human" )
kable(m_pfoa_1$GO_Biological_Process_2018[1:5, ], 
      caption = "Male pfoa Top1 DMR: GO_Biological_Process_2018" )
...
m_pfoa_500 <- getpathway_top( "m_pfoa_DMP_500",  dbs, top500_gene)
kable(m_pfoa_500$KEGG_2019_Human[1:5, ], 
      caption = "Male pfoa Top500 DMP: KEGG_2019_Human" )
kable(m_pfoa_500$GO_Biological_Process_2018[1:5, ], 
      caption = "Male pfoa Top500 DMP: GO_Biological_Process_2018" )
kable(m_pfoa_500$GO_Molecular_Function_2018[1:5, ], 
      caption = "Male pfoa Top500 DMP: GO_Molecular_Function_2018" )
kable(m_pfoa_500$GO_Cellular_Component_2018[1:5, ], 
      caption = "Male pfoa Top500 DMP: GO_Cellular_Component_2018" )
